...
export function EditBook() {
    ...
    const genres = ['Fiction', 'Non-Fiction', 'Self-Help', 'Mystery', 'Science Fiction', 'Biography', 'Romance', 'Thriller'];
    ...
    function handleSubmit(e) {
        ...
        if (!bookStock || parseInt(bookStock) < 0) {
            enqueueSnackbar("Please enter a valid stock quantity", { variant: 'warning' });
            return;
        }
        if (!bookRating || parseFloat(bookRating) < 0 || parseFloat(bookRating) > 5) {
            enqueueSnackbar("Please enter a valid rating between 0 and 5", { variant: 'warning' });
            return;
        }
        ...
        axios.put(`http://localhost:8080/books/edit/${id}`, data)
            .then(res => {
                ...
                console.log(err);
                setIsLoading(false);
                enqueueSnackbar("Some error occurred while updating the record, please try again!", { variant: 'error' })
            })
    }
                                ...
                                <div className="p-8">
                                    <div className="space-y-6">
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            ...
                                            <div>
                                                <label htmlFor="bookPrice" className="block text-sm font-semibold text-gray-700 mb-2">
                                                    Price ($) *
                                                </label>
                                                <input
                                                    type="number"
                                            ...
                                            <div>
                                                <label htmlFor="bookStock" className="block text-sm font-semibold text-gray-700 mb-2">
                                                    Stock Quantity *
                                                </label>
                                                <input
                                                    type="number"
                                            ...
                                            <div>
                                                <label htmlFor="bookRating" className="block text-sm font-semibold text-gray-700 mb-2">
                                                    Rating (0-5) *
                                                </label>
                                                <input
                                                    type="number"
