...
import { BookOpen, User, Tag, DollarSign, Package, Star, Calendar, Clock } from "lucide-react";
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                                    <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg">
                                        ...
                                        <div>
                                            ...
                                            <span className={`text-xs font-semibold ${book.stock || 0 > 10 ? 'text-green-600' :
                                                    book.stock || 0 > 0 ? 'text-yellow-600' :
                                                        'text-red-600'
                                                }`}>
                                                {book.stock || 0 > 10 ? 'In Stock' :
                                                    book.stock || 0 > 0 ? 'Low Stock' :
                                                        'Out of Stock'}
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg">
                                        ...
                                        <div>
                                            ...
                                            <span className="text-xs text-gray-500">
                                                {book.stock || 0} units x ${(book.price || 0).toFixed(2)}
                                            </span>
                                        </div>
                                    </div>
                                </div>
