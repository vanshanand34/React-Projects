...
export function DeleteModal({ bookId, onClose }) {
    ...
    return (
        <div
            className="fixed bg-black/60 top-0 bottom-0 left-0 right-0 
        ...
        >
            ...
            >
                ...
                <div className="flex justify-center items-center p-2 gap-x-4">
                    <button className="px-3 py-1 bg-red-300 hover:bg-red-400 rounded cursor-pointer" onClick={deleteBook}>Yes</button>
                    <button className="px-3 py-1 bg-sky-400 hover:bg-sky-500 rounded cursor-pointer" onClick={onClose}>No</button>
                </div>
            </div>
        </div>
    )
